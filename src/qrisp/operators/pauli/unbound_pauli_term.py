...
class UnboundPauliTerm:
    ...
    def copy(self):
        return UnboundPauliTerm(self.pauli_dict.copy())
    ...
    def to_expr(self):
        """
        Returns a SymPy expression representing the UnboundPauliTerm.

        Returns
        -------
        expr : sympy.expr
            A SymPy expression representing the UnboundPauliTerm.
    ...
    def __mul__(self, other):
        ...
        for key in keys:
            ...
            if pauli!="I":
                ...
                result_coeff *= coeff
        return UnboundPauliTerm(result_pauli_dict), result_coeff
    ...
    def subs(self, subs_dict):
        ...
        -------
        UnboundPauliTerm
            The resulting UnboundPauliTerm.
    ...
    def commute(self, other):
        """
        Checks if two UnboundPauliTerms commute.
    ...
    def commute_qw(self, other):
        """
        Checks if two UnboundPauliTerms commute qubit-wise.
